...
const tabsListVariants = cva(
  "group/tabs-list inline-flex max-w-full w-fit items-center justify-start overflow-x-auto no-scrollbar rounded-lg p-[3px] text-muted-foreground group-data-horizontal/tabs:h-8 group-data-vertical/tabs:h-fit group-data-vertical/tabs:flex-col data-[variant=line]:rounded-none",
  {
    variants: {
      variant: {
        default: "bg-muted",
