...
function InputGroupInput({
  ...
  return (
    <Input
      ...
      // h-full, not the Input height scale: inside a group the wrapper owns
      // the height, and a fixed inner height leaves the caret sitting in a
      // 32px box inside a 44px field.
      className={cn(
