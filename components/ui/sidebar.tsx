    ...
    >
      ...
      >
        <div
          ...
          className="flex size-full flex-col overflow-hidden bg-sidebar group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:shadow-sm group-data-[variant=floating]:ring-1 group-data-[variant=floating]:ring-sidebar-border group-data-[variant=inset]:rounded-xl group-data-[variant=inset]:bg-background group-data-[variant=inset]:shadow-sm"
        >
          {children}
        </div>
      </div>
